...
These interfaces represent the core data structures used in the frontend.
**Rule:** API responses (typically `snake_case`) must be transformed to `camelCase` before being used in components.
