...
import { InviteCodeInput } from '@/features/study/components/setting/InviteCodeInput';
...
const StudySettingPage = async ({ params }: Props) => {
  ...
  return (
    <main className="min-h-0 w-full flex-1 overflow-y-auto">
      <div className="mx-auto flex w-full max-w-3xl flex-col gap-18 px-5 py-10 md:p-12">
        <div className="flex flex-col gap-6">
          ...
          <UpdateStudyForm id={id} initialData={study} role={role} />
          <InviteCodeInput inviteCode={study.inviteCode} />
        </div>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-3">
