    ...
    <div className="bg-background min-h-screen px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-8 leading-relaxed">
          <section>
            <p className="mb-4">
              <strong>CodTe</strong>(이하 &apos;회사&apos;라고 함)는 회사가
              제공하고자 하는 서비스(이하 &apos;회사 서비스&apos;)를 이용하는
              개인(이하 &apos;이용자&apos; 또는 &apos;개인&apos;)의 정보(이하
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제3조(본 방침의 공개)</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제4조(본 방침의 변경)</h2>
            <ol className="list-decimal space-y-2 pl-5">
              <li>
              ...
              <li>
                회사는 제1항에 따라 본 방침을 개정하는 경우 다음 각호 하나
                이상의 방법으로 공지합니다.
          ...
          <section>
            ...
            <ul className="mt-2 list-decimal pl-5">
              <li>
                <strong>필수 수집 정보</strong>: 이메일 주소 및 이름
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제7조(개인정보의 이용)</h2>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold">
                  1. 전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보
                  및 보유기간
                </h3>
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제11조(개인정보파기절차)</h2>
            <ol className="list-decimal space-y-2 pl-5">
              <li>
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제12조(개인정보파기방법)</h2>
            <p>
          ...
          <section>
            ...
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li>
                ...
                또는 전자우편주소로 연락하시면 회사는 지체 없이 조치하겠습니다.
              </li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal space-y-2 pl-5">
              ...
              <li>
                ...
                이미 제공한 경우에는 정정 처리결과를 제3자에게 지체 없이
          ...
          <section>
            <h2 className="mb-3 text-xl font-bold">제16조(이용자의 의무)</h2>
            <ol className="list-decimal space-y-2 pl-5">
              <li>
          ...
          <section>
            ...
            <ul className="text-muted-foreground list-disc space-y-1 pl-5">
              <li>
                <strong>Edge</strong>: 웹브라우저 우측 상단의 설정 메뉴 &gt;
                쿠키 및 사이트 권한 &gt; 쿠키 및 사이트 데이터 관리 및 삭제
              </li>
              <li>
                <strong>Chrome</strong>: 웹브라우저 우측 상단의 설정 메뉴 &gt;
                개인정보 및 보안 &gt; 쿠키 및 기타 사이트 데이터
              </li>
              <li>
                <strong>Whale</strong>: 웹브라우저 우측 상단의 설정 메뉴 &gt;
