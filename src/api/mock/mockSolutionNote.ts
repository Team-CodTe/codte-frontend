...
const getProblemById = (id: number) =>
  MOCK_PROBLEMS.find((problem) => problem.id === id);

export const MOCK_SOLUTION_NOTES: SolutionNoteResponse[] = [
  // =================================================================
  // [11월 25일] 과제: 보석 도둑(101), 아기 상어(102)
  // =================================================================
  {
    id: 1,
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(101)!, // 보석 도둑
    content:
    ...
    createdAt: '2025-11-25 14:40:11',
    updatedAt: '2025-11-25 14:40:11',
  },
  {
    id: 2,
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(102)!, // 아기 상어
    content:
    ...
    createdAt: '2025-11-25 18:20:15',
    updatedAt: '2025-11-25 18:20:15',
  },

  // =================================================================
  // [11월 26일] 과제: 연구소(103), N-Queen(104), AC(105), 토마토(106)
  // =================================================================
  {
    id: 3,
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(103)!, // 연구소
    content:
    ...
    createdAt: '2025-11-26 10:23:15',
    updatedAt: '2025-11-26 10:23:15',
  },
  {
    id: 4,
    study: MOCK_STUDY,
    user: MOCK_USER_4,
    problem: getProblemById(105)!, // AC
    content:
    ...
    createdAt: '2025-11-26 12:30:55',
    updatedAt: '2025-11-26 12:30:55',
  },
  {
    id: 5,
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(106)!, // 토마토
    content:
    ...
    createdAt: '2025-11-26 13:15:20',
    updatedAt: '2025-11-26 13:15:20',
  },
  {
    id: 6,
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(104)!, // N-Queen
    content:
    ...
    createdAt: '2025-11-26 16:05:50',
    updatedAt: '2025-11-26 16:05:50',
  },
  {
    id: 7,
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(106)!, // 토마토 (중복 풀이)
    content:
      '## 문제 풀이\n\n### 1. 문제 분석\nBFS 응용 문제입니다.\n\n### 2. 접근 방식\n익은 토마토가 있는 위치를 모두 큐에 넣는 것이 핵심입니다.\n\n### 3. 코드 구현\n2차원 배열을 순회하며 초기 큐 세팅을 하고 BFS를 돌렸습니다.\n\n### 추가 메모\n토마토가 하나도 없는 경우는 없다고 가정했습니다.',
    createdAt: '2025-11-26 20:05:10',
    updatedAt: '2025-11-26 20:05:10',
  },
  {
    id: 8,
    study: MOCK_STUDY,
    user: MOCK_USER_4,
    problem: getProblemById(103)!, // 연구소 (중복 풀이)
    content:
    ...
    createdAt: '2025-11-26 21:30:22',
    updatedAt: '2025-11-26 21:30:22',
  },
  {
    id: 9,
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(105)!, // AC (중복 풀이)
    content:
    ...
    createdAt: '2025-11-26 22:45:05',
    updatedAt: '2025-11-26 22:45:05',
  },

  // =================================================================
  // [11월 27일] 과제: 미로 탐색(107), 회의실(108), DFS/BFS(109), 1로 만들기(110)
  // =================================================================
  {
    id: 10,
    study: MOCK_STUDY,
    user: MOCK_USER_4,
    problem: getProblemById(107)!, // 미로 탐색
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(110)!, // 1로 만들기
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(109)!, // DFS와 BFS
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_4,
    problem: getProblemById(110)!, // 1로 만들기 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(107)!, // 미로 탐색 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(109)!, // DFS와 BFS (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(108)!, // 회의실 배정 (중복 풀이)
    content:
  ...
  // =================================================================
  // [11월 28일] 과제: 테토(111), 2xn타일링(112), 계단수(113), 가스관(114), 폴리큐브(115)
  // =================================================================
  {
    id: 18,
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(113)!, // 쉬운 계단 수
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(113)!, // 쉬운 계단 수 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(112)!, // 2xn 타일링 2
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_4,
    problem: getProblemById(112)!, // 2xn 타일링 2 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(115)!, // 폴리큐브의 겉넓이
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(115)!, // 폴리큐브의 겉넓이 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_1,
    problem: getProblemById(114)!, // 가스관
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(114)!, // 가스관 (중복 풀이)
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_2,
    problem: getProblemById(111)!, // 테토와 바게트
    content:
  ...
  },
  {
    ...
    study: MOCK_STUDY,
    user: MOCK_USER_3,
    problem: getProblemById(111)!, // 테토와 바게트 (중복 풀이)
    content:
